<?php //netteCache[01]000484a:2:{s:4:"time";s:21:"0.14980100 1427055578";s:9:"callbacks";a:3:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:95:"/home/monkeyen/public_html/businessfinder/wp-content/themes/businessfinder/Templates/header.php";i:2;i:1426999065;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:30:"eee17d5 released on 2011-08-13";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:21:"WPLATTE_CACHE_VERSION";i:2;i:4;}}}?><?php

// source file: /home/monkeyen/public_html/businessfinder/wp-content/themes/businessfinder/Templates/header.php

?><?php list($_l, $_g) = NCoreMacros::initRuntime($template, '2yxhi3t3ps')
;
// snippets support
...
<?php NCoreMacros::includeTemplate('snippets/branding-header.php', $template->getParams(), $_l->templates['2yxhi3t3ps'])->render() ?>

<?php if ($headerType != 'map' || isset($itemDetailEmpty)): ?>
...
<?php endif ?>
							...
							<div id="dir-search-button">
								<input id="dir-searchsubmit" type="submit" value="<?php echo htmlSpecialChars(__('Search', 'ait')) ?>" class="dir-searchsubmit" />
							</div>
							<input type="hidden" name="dir-search" value="yes" />
							<?php if (!empty($_GET['lang'])): ?><input type="hidden" name="lang" value="<?php echo htmlSpecialChars($_GET['lang']) ?>
" /><?php endif ?>
...
<?php if (isset($isDirSingle)): NCoreMacros::includeTemplate('snippets/map-single-javascript.php', $template->getParams(), $_l->templates['2yxhi3t3ps'])->render() ;else: if ($headerType == 'map'): NCoreMacros::includeTemplate('snippets/map-javascript.php', $template->getParams(), $_l->templates['2yxhi3t3ps'])->render() ;endif ;endif ;
